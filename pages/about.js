    ...
    >
      <LeftContent>
        <NeueLightMiniText style={{ marginBottom: '30px' }}>
          ...
          box for new & innovate ideas that can solve gobal problems with
          amazing knowledge and technologies. I expetise is around web
          technologies. Other then this, I love playing video games, making
        ...
        >
          ...
          to collect oceanic climate data. And the problem is that because of
          slow and unstable internet connectivity, they are unable to send real
          time data to servers and often lose data because of no internet. We
          have to make an app that can solve this massive problem.
          ...
          this & discuss with my other peeps about this problem. After research
          I found out that this is a offline database & sync problem. Then my
      ...
      <RightContent>
        ...
        <ChatsBox>
          <NeueLightMiniText>skype</NeueLightMiniText>
          <NeueLightMiniText>discord</NeueLightMiniText>
          <NeueLightMiniText>hangout</NeueLightMiniText>
